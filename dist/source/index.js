...
var _a, _b;
var _Conf_encryptionKey, _Conf_options, _Conf_defaultValues, _Conf_validator;
...
class Conf {
    constructor(partialOptions = {}) {
        ...
        const loadValidator = (afterMigration) => {
            if (options.schema) {
                ...
                __classPrivateFieldSet(this, _Conf_validator, ajv.compile(afterMigration ? schema : {}), "f");
    ...
    *[(_Conf_encryptionKey = new WeakMap(), _Conf_options = new WeakMap(), _Conf_defaultValues = new WeakMap(), _Conf_validator = new WeakMap(), Symbol.iterator)]() {
